...
module Cocov
  ...
  GIT_SERVICE_S3_STORAGE_BUCKET_NAME = ENV.fetch("COCOV_GIT_SERVICE_S3_STORAGE_BUCKET_NAME", "")

  CRYPTOGRAPHIC_KEY = ENV.fetch("COCOV_CRYPTOGRAPHIC_KEY", nil)

  REPOSITORY_CACHE_MAX_SIZE = [0, ENV.fetch("COCOV_REPOSITORY_CACHE_MAX_SIZE", "0").to_i].max
  CACHE_SERVICE_URL = ENV.fetch("COCOV_CACHE_SERVICE_URL", nil)

  SIDEKIQ_PROBE_ADDRESS = ENV.fetch("COCOV_SIDEKIQ_PROBE_ADDRESS", "0.0.0.0")
  SIDEKIQ_PROBE_PORT = ENV.fetch("COCOV_SIDEKIQ_PROBE_PORT", 8668).to_i
end
